...
if __name__ == '__main__':
    ...
    for i in range(args.n_runs):
        ...
        metrics = trainer.evaluate(y_true, scores, threshold=tau)
        print(metrics)
    ...
    all_params = {"tau": tau, "rho": "%1.4f" % ds.anomaly_ratio, **model.get_params()}
    store_results(all_params, res, args.model, args.dataset, args.dataset_path)